...
<div class="slider-wrapper" style="position: relative;">
    ...
    <div class="image-list slide-1">
        <?php if (isset($new_arrivals) && is_array($new_arrivals)): ?>
            ...
            <?php endforeach; ?>
        <?php else: ?>
            <!-- Fallback content if no new arrivals -->
            <div class="image-item">
                <div class="image-image">
                    <img src="/img/New_Arrivals/NA1.avif" alt="First Image">
                    <div class="price">2,100,000₫</div>
                    <div class="image-icon"><i class="fa-regular fa-heart"></i></div>
                </div>
                <p class="product-name">adidas x Jay3lle Long Sleeve Mock <br> Tee</p>
                <p class="product-category">Performance</p>
            </div>
...
<div class="slider-scrollbar">
    ...
    <h1 class="whatshot">WHAT'S HOT</h1>
        ...
        <div class="image-list-2">
            <div class="image-item-2">
                <div class="image-image-2" >
                    <img src="/img/whatshot/wh1.avif" alt="First Image"    >                  
                </div>
                
                <p class="sw2" style="margin-top: 15px;">CLOT August Collection By Edison Chen</p>                   
                
                <p class="sw3">Craft your own reality with the first global unisex collection from adidas Originals and Edison Chen.</p>
                <a href="#" class="sw4">SHOP NOW</a>
            </div>

            <div class="image-item-2">
                <div class="image-image-2" style="position: relative;">
                    <video loop="" muted="" autoplay="" playsinline=""><source src="/img/whatshot/wh2.mp4" type="video/mp4" ></video>                  
                </div>
                <p class="sw2">Ultraboost 5</p> 
                <p class="sw3">More cushion, more comfort, less weight—now in black and white colourways.</p>
                <a href="#" class="sw4">SHOP NOW</a>
            </div>

            <div class="image-item-2">
                <div class="image-image-2" style="position: relative;">
                    <img src="/img/whatshot/wh3.avif " alt="First Image"    >                  
                </div>
                <p class="sw2" style="margin-top: 15px;">A Timeless Legacy</p> 
                <p class="sw3">Our most iconic Originals trainers got the 75-year-anniversary makeover.</p>
                <a href="#" class="sw4">SHOP NOW</a>
            </div>

            <div class="image-item-2">
                <div class="image-image-2" style="position: relative;">
                    <video loop="" muted="" autoplay="" playsinline=""><source src="/img/whatshot/wh4.mp4" type="video/mp4" ></video>                  
                </div>
                <p class="sw2">A summer of champions</p> 
                <p class="sw3">Pushing limits in the city of lights.</p>
                <a href="#" class="sw4">SHOP NOW</a>
            </div>

            <div class="image-item-2">
                <div class="image-image-2" style="position: relative;">
                    <img src="/img/whatshot/wh5.png" alt="First Image"    >                  
                </div>
                <p class="sw2" style="margin-top: 15px;">YEEZY</p> 
                <p class="sw3">Access a limited selection of adidas YEEZY with up to 70% off.</p>
                <a href="#" class="sw4">SHOP NOW</a>
            </div>

            <div class="image-item-2">
                <div class="image-image-2" style="position: relative;">
                    <img src="/img/whatshot/wh6.avif" alt="First Image"    >                  
                </div>
                <p class="sw2" style="margin-top: 15px;">Codechaos 25</p> 
                <p class="sw3">High-tech performance footwear to rev up your game.</p>
                <a href="#" class="sw4">SHOP NOW</a>
            </div>

            <div class="image-item-2">
                <div class="image-image-2" style="position: relative;">
                    <img src="/img/whatshot/wh7.gif" alt="First Image"    >                  
                </div>
                <p class="sw2" style="margin-top: 15px;">CLOT August Collection By Edison Chen</p> 
                <p class="sw3">adidas Originals and Edison Chen unveil their first global unisex collection with an updated CLOT Gazelle.</p>
                <a href="#" class="sw4">SHOP NOW</a>
            </div>

            <div class="image-item-2">
                <div class="image-image-2" style="position: relative;">
                    <video loop="" muted="" autoplay="" playsinline=""><source src="/img/whatshot/wh8.mp4" type="video/mp4" width="1080" height="1440"></video>                  
                </div>
                <p class="sw2">CLOT August Collection By Edison Chen</p> 
                <p class="sw3">adidas Originals and Edison Chen unveil their first global unisex collection with an updated CLOT Gazelle.</p>
                <a href="#" class="sw4">SHOP NOW</a>
            </div>
        </div>
    ...
    <div class="slider-wrapper-2">
        ...
        <div class="image-list-2">
            <div class="image-item-2">
                <div class="image-image-2" >
                    <img src="/img/ADICOLOR/ADICOLOR1.avif" alt="First Image"    >                  
                </div>
                
                <p class="sw2">RED</p>                   
                
                <p class="sw3">adicolor</p>
                <a href="#" class="sw4">SHOP NOW</a>
            </div>

            <div class="image-item-2">
                <div class="image-image-2" >
                    <img src="/img/ADICOLOR/ADICOLOR2.avif" alt="First Image"    >                  
                </div>
                
                <p class="sw2">ORANGE</p>                   
            ...
            <div class="image-item-2">
                <div class="image-image-2" >
                    <img src="/img/ADICOLOR/ADICOLOR3.avif" alt="First Image"    >                  
                </div>
                
                <p class="sw2">YELLOW</p>                   
            ...
            <div class="image-item-2">
                <div class="image-image-2" >
                    <img src="/img/ADICOLOR/ADICOLOR4.avif" alt="First Image"    >                  
                </div>
            ...
            <div class="image-item-2">
                <div class="image-image-2" >
                    <img src="/img/ADICOLOR/ADICOLOR5.avif" alt="First Image"    >                  
                </div>
            ...
            <div class="image-item-2">
                <div class="image-image-2" >
                    <img src="/img/ADICOLOR/ADICOLOR6.avif" alt="First Image"    >                  
                </div>
                
                <p class="sw2">PURPLE</p>                   
    ...
    <div class="below-mobile-4">
        <div class="below-mobile-4-container">
            <div class="below-mobile-4-column">
                <ul>
                    <li><a href="#">Store Finder</a></li>
                    <li><a href="#">FAQs</a></li>
                    <li><a href="#">Careers</a></li>
            ...
            <div class="below-mobile-4-column">
                <ul>
                    <li><a href="#">Contact Online Shop</a></li>
                    <li><a href="#">Sitemap</a></li>
                    <li><a href="#">Delivery</a></li>
                </ul>
            </div>
