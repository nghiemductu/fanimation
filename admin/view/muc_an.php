        ...
        <tbody>
            ...
            <tr class="text-center">
                ...
                <td class="align-middle">
                    <a href="index.php?act=restore_category&id=<?php echo $dm['id']; ?>" class="btn btn-sm btn-success w-10" onclick="return confirm('Bạn có chắc muốn khôi phục danh mục này?')">Khôi phục</a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            <tr class="text-center">
                ...
                <td class="align-middle">
                    <a href="index.php?act=restore_product&id=<?php echo $sp['id']; ?>" class="btn btn-sm btn-success w-10" onclick="return confirm('Bạn có chắc muốn khôi phục sản phẩm này?')">Khôi phục</a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
